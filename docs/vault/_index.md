...
**El 2026-09-23 el dueño pidió repararlos.** Los dos de uso están **escritos**
(ADR 015 §5 y §6): el formulario usa dos columnas en escritorio, y cargar,
subir la foto y publicar pasan a ser un solo gesto. El del CORS se intentó
—dos veces, la segunda con autorización explícita— y **lo sigue frenando el
clasificador de permisos**, que es un bloqueo de configuración y no algo que
una autorización en el chat destrabe. Los tres siguen en *Lo que quedó
abierto*, ahora con su estado real: dos escritos sin desplegar, uno bloqueado.
