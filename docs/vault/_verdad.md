...
> **Generado:** 2026-09-25 - commit `f900838` - huella del cuerpo `465fd503e18b`
...
| `por_fuera` | SI | **terminal** |

Nace en: `pendiente`, `pagada`, `por_fuera`. Terminales: `reembolsada`, `por_fuera`.
...
### Proyeccion - 36 pares sobre 36 posibles
...
### Scripts de la raiz - `bouquet` 0.37.0
...
| `scripts/reglas/ordenes.test.mjs` | 29 |
...
| `CORREOS` | valor | solo el generador | `packages/contratos/scripts/generar.mjs`, `packages/contratos/test/despacho.test.ts` |
| `LARGO_DEL_SEGUIMIENTO` | valor | solo el generador | `packages/contratos/scripts/generar.mjs` |
| `sePuedeDespachar` | funcion | solo el generador | `packages/contratos/scripts/generar.mjs`, `packages/contratos/test/despacho.test.ts` |
| `MOTIVOS_DE_FALLA` | valor | solo el generador | `packages/contratos/scripts/generar.mjs`, `packages/contratos/test/despacho.test.ts` |
| `SOLO_LO_ESCRIBE_EL_SERVIDOR` | valor | abierto | `functions/src/pedidos/cancelar.ts`, `packages/contratos/scripts/generar.mjs`, `packages/contratos/test/despacho.test.ts` |
| `laEscribeElPanel` | funcion | solo el generador | `packages/contratos/scripts/generar.mjs`, `packages/contratos/test/despacho.test.ts`, `scripts/reglas/ordenes.test.mjs` |
| `MOTIVOS_DE_CANCELACION` | valor | solo el generador | `packages/contratos/scripts/generar.mjs`, `packages/contratos/test/despacho.test.ts` |
| `MOTIVOS_SIN_REPONER` | valor | solo el generador | `packages/contratos/scripts/generar.mjs`, `packages/contratos/test/despacho.test.ts` |
...
Archivos de codigo recorridos: 148. Archivos de test: 54. Casos de test: 823.
